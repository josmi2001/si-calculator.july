...
<h2 className='text-danger fw-bolder' style={{textDecoration:'underline'}}>Simple-Interst-Calculator</h2>
<p className='text-center'>Calculate your simple interst with us</p>
...
<div className="mt-5">
  ...
  <TextField id="principle" name='principle' value={principle} label="Principle Amount" variant="outlined" 
